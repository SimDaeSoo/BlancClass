...
export function getLightingPolygon(position, lines, length) {
...
export function getLineMaxLength(lines) {
...
export function lineMerge(lines) {
    const mergedLines = [];
...
export function getAxisLines(lines, vector) {
